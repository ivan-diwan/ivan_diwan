...
class PropertyPanelSmokeTests(unittest.TestCase):
    ...
    def test_leaf_and_container_property_sets_match_supported_types(self) -> None:
        expected_properties = {
            ...
            "QDateEdit": {"geometry_locked", "date", "minimum_date", "maximum_date"},
            "QCalendarWidget": {"geometry_locked", "selected_date", "minimum_date", "maximum_date"},
            "QTimeEdit": {"geometry_locked", "time", "minimum_time", "maximum_time"},
            "QDateTimeEdit": {"geometry_locked", "datetime", "minimum_datetime", "maximum_datetime"},
